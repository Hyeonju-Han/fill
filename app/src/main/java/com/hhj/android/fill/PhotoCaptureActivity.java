...
public class PhotoCaptureActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 상태바와 타이틀 설정
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);//상태바 안보이게함
//        requestWindowFeature(Window.FEATURE_NO_TITLE);//타이틀바 없애기

        setContentView(R.layout.photo_capture_activity);//레이아웃 연결

        mCameraView = new CameraSurfaceView(getApplicationContext(), this);
